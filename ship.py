...
class Ship(object):
	def __init__(self, course, speed):
		...
		self.rudder_angle = 0
		self.rudder_angle_ordered = 0
		self.rate_speed_change = 0.1 # knots / second
		self.rate_rudder_change = 2 # degrees / second
		self.rate_course_change = 0.1 # degrees / (knots_of_speed * degrees_of_rudder * second)
		self.time_rudder_ease = 5 # seconds looking ahead to reduce turn rate to not overshoot desired course
